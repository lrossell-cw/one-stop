# One-Stop-Shop — PHX01 Site App

## What this is
An internal tool for PHX01 (US-WEST-02, Phoenix). Two core features:
...
- Topology: 3 hops — `MMR ↔ DH151 ↔ DH120 ↔ DH160`.
...
### Routing behavior ("train track switch")
- This is about topology, not animation. If a circuit's endpoint changes (re-patched to a different port/cassette/hall), the drawn path on the map must re-route to visually follow the *actual* current connection — the way a rail switch redirects a train to a different track.
